...
/**
 * Homepage Contact Section - Full Screen Slide
 * Mirrors the Lawyer Landing Page Contact Form
 */
const HomepageContact: React.FC = () => {
  ...
  return (
    <section className="min-h-screen md:h-screen w-full flex items-center justify-center overflow-hidden relative bg-brand-black perspective-1000 py-20 md:py-0">
      {/* Background Image with Blur */}
      <div 
        className="absolute inset-0 bg-[url('/assets/images/bg_contact.png')] bg-cover bg-center bg-no-repeat blur-xl transform scale-105 opacity-50"
        style={{ zIndex: 0 }}
      />
      
      <div className="container mx-auto px-6 relative z-10 max-w-7xl h-full flex items-center justify-center">
        <div className="bg-black/60 md:bg-black/30 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-12 shadow-2xl w-full z-50 pointer-events-auto relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-4 py-3 md:px-6 md:py-4 text-base text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-brick/50 focus:bg-white/10 transition-all font-light"
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full bg-white/[0.03] border border-white/10 rounded-2xl px-4 py-3 md:px-6 md:py-4 text-base text-white placeholder:text-gray-600 focus:outline-none focus:border-brand-brick/50 focus:bg-white/10 transition-all resize-none font-light"
