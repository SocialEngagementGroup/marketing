...
import { Quote, ArrowDownRight } from 'lucide-react';
import { webSolutionsTestimonials } from '../../../data/testimonials';

const testimonials = webSolutionsTestimonials || [];
...
const Testimonials: React.FC = () => {
  ...
  return (
    <section className="py-20 md:py-32 bg-[#064232] overflow-hidden">
            ...
            <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 relative min-h-[420px] sm:min-h-[400px] md:min-h-[330px] flex flex-col">
              ...
              <div className="p-8 md:p-12 flex-grow overflow-hidden relative flex flex-col">
                ...
                <div className="mt-auto pt-4 border-t border-gray-50 flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#064232] font-outfit">{current.author}</h4>
                    <p className="text-[#0A5D46] text-sm font-semibold font-outfit">
