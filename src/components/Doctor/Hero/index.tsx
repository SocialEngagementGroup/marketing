  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[20%] left-[-20%] w-[700px] h-[700px] bg-blue-100/40 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob" style={{ animationDelay: '2s' }} />
        ...
        <div className="max-w-5xl flex flex-col items-center">
          ...
          <div className="mb-8">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-brand-black tracking-tight leading-[1.1] flex flex-col items-center">
              <TextReveal className="justify-center">Scale Your Practice</TextReveal>
              <div className="flex flex-wrap justify-center gap-x-4">
                 <TextReveal className="text-brand-brick justify-center" delay={0.4}>Serve More</TextReveal>
                 <TextReveal className="justify-center" delay={0.6}>Patients.</TextReveal>
              </div>
            </h1>
          </div>
          ...
          >
            The elite marketing engine for medical professionals. We build patient acquisition systems that don't just generate clicks—they fill schedules.
          </motion.p>
